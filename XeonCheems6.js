...
const buttons = [
  ...
  {buttonId: 'donate', buttonText: {displayText: 'BOTLINK 🖇️'}, type: 1},
  {buttonId: 'owner', buttonText: {displayText: 'OWNER 🥷'}, type: 1}
]
const buttonMessage = {
    image: unicorn,
    caption: `╔═══════✪ OWNER🥷🏻	
╠ ${prefix}JOIN [LINK] අදාල ගෘප් එකට යාමට.
╠ ${prefix}SETBOTPP [IMAGE]
╠ ${prefix}BLOCK [TAG/NUMBER] ඔහුව බොට් විසින් බ්ලොක් කරයි.
╠ ${prefix}UNBLOCK [NUMBER/TAG] ඔහුව UNBLOCK කරයි.
╠═══════✪ *GROUP👥* 	        
...
╠${prefix}MEDIAFIRE [LINK] MEDIAFIRE ලින්ක් එකට අදාල ෆයිල් එක ලබා දෙයි.
╠═══════✪ IMG EFFECT 
╠${prefix}REMOVEBG  [REPLY IMG] එම ෆොටො එකෙ පසුබිම යිවත් කර ලබා දෙයි.
╠═══════=「 ~😈BUG SPAMMENU😈~ 」	
╠════🖥️PC ATTACK🖥️
╠${prefix}PCBUG [NUMBER]
╠${prefix}PCVN [NUMBER]
